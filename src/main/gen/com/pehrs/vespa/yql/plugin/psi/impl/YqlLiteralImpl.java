...
public abstract class YqlLiteralImpl extends YqlLiteralMixin implements YqlLiteral {

  public YqlLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public boolean isQuotedString() {
    return YqlPsiImplUtils.isQuotedString(this);
  }
