package com.pehrs.vespa.yql.plugin.swing;
import java.awt.*;
...
// Based on https://github.com/tips4java/tips4java/blob/main/source/TableColumnAdjuster.java
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener
{
  ...
  private int columnMaxWidth = Integer.MAX_VALUE;
  ...
  public void adjustColumn(final int column)
  {
    ...
    preferredWidth = Math.min(preferredWidth, columnMaxWidth);
  ...
  public void setColumnMaxWidth(int maxWidth) {
